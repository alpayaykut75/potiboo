-- Interval: eşikler artık kazandırır (>= lo ve <= hi)
-- Aynı sayı (lo = hi) → pas zorunlu
...
begin
  ...
  -- Aynı sayı gelirse pas zorunlu; farklıysa eşikler de geçerli
  if v_hi = v_lo then
...
-- interval_pass: aynı sayı kontrolü güncelle
